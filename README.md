...
If you are using HTTPS
    ...
    "git clone https://github.com/ijeomaodinko/hello-front-end.git

If you are using a SSH key.

    "git clone git@github.com:ijeomaodinko/hello-front-end.git
...
Clone this repository to your desired folder:
    ...
    git clone https://github.com/ijeomaodinko/hello-back-end.git
